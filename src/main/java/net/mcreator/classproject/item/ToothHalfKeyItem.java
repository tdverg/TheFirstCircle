...
public class ToothHalfKeyItem extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:tooth_half_key")
	public static final Item block = null;
	public ToothHalfKeyItem(ClassprojectModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tooth_half_key");
		}
