...
public class HolyKeyItem extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:holy_key")
	public static final Item block = null;
	public HolyKeyItem(ClassprojectModElements instance) {
		super(instance, 50);
	}
