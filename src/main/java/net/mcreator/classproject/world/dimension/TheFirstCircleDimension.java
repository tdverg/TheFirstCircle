...
package net.mcreator.classproject.world.dimension;
...
import net.mcreator.classproject.procedures.FirstCirclePortalParticlesProcedure;
import net.mcreator.classproject.procedures.FirstCircleOnPlayerEnterDimensionProcedure;
import net.mcreator.classproject.procedures.CheckFinalItemProcedure;
import net.mcreator.classproject.item.TheFirstCircleItem;
import net.mcreator.classproject.block.LimbgrassBlock;
import net.mcreator.classproject.block.BluestoneBlock;
...
public class TheFirstCircleDimension extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:the_first_circle_portal")
	public static final CustomPortalBlock portal = null;
	public TheFirstCircleDimension(ClassprojectModElements instance) {
		super(instance, 37);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(LimbgrassBlock.block).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("classproject:the_first_circle"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("the_first_circle_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("the_first_circle_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("the_first_circle_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new TheFirstCircleItem().setRegistryName("the_first_circle"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				FirstCirclePortalParticlesProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					...
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("classproject:the_first_circle")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getFrom() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("classproject:the_first_circle"))) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				CheckFinalItemProcedure.executeProcedure($_dependencies);
			}
		}
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("classproject:the_first_circle"))) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FirstCircleOnPlayerEnterDimensionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
