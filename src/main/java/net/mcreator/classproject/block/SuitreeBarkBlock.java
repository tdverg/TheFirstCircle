...
public class SuitreeBarkBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:suitree_bark")
	public static final Block block = null;
	public SuitreeBarkBlock(ClassprojectModElements instance) {
		super(instance, 33);
	}
