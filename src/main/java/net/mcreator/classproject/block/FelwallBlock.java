...
public class FelwallBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:felwall")
	public static final Block block = null;
	public FelwallBlock(ClassprojectModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 1).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("felwall");
		}
