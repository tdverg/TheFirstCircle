...
public class FaerieweedBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:faerieweed")
	public static final Block block = null;
	public FaerieweedBlock(ClassprojectModElements instance) {
		super(instance, 24);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("faerieweed"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("classproject:faerieweed"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == LimbgrassBlock.block);
		}
