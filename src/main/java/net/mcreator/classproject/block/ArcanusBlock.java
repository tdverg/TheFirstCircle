...
public class ArcanusBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:arcanus")
	public static final Block block = null;
	public ArcanusBlock(ClassprojectModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 1)
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("arcanus");
		}
