...
public class LimbstoneBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:limbstone")
	public static final Block block = null;
	public LimbstoneBlock(ClassprojectModElements instance) {
		super(instance, 12);
	}
