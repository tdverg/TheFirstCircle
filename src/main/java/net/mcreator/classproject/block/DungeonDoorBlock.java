...
import net.mcreator.classproject.procedures.CheckDungeonItemProcedure;
...
public class DungeonDoorBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:dungeon_door")
	public static final Block block = null;
	public DungeonDoorBlock(ClassprojectModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends DoorBlock {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CheckDungeonItemProcedure.executeProcedure($_dependencies);
			}
