...
public class LimbgrassBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:limbgrass")
	public static final Block block = null;
	public LimbgrassBlock(ClassprojectModElements instance) {
		super(instance, 23);
	}
