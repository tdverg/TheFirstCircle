...
public class AsphodelBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:asphodel")
	public static final Block block = null;
	public AsphodelBlock(ClassprojectModElements instance) {
		super(instance, 25);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("asphodel"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("classproject:asphodel"), configuredFeature);
		}
	}
	@SubscribeEvent
