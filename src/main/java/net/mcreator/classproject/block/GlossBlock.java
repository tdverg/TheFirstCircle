...
public class GlossBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:gloss")
	public static final Block block = null;
	public GlossBlock(ClassprojectModElements instance) {
		super(instance, 46);
	}
