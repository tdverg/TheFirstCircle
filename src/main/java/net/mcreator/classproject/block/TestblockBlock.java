...
public class TestblockBlock extends ClassprojectModElements.ModElement {
	@ObjectHolder("classproject:testblock")
	public static final Block block = null;
	public TestblockBlock(ClassprojectModElements instance) {
		super(instance, 28);
	}
